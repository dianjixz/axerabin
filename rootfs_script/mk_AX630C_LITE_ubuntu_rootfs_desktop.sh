...
cp --preserve=mode,timestamps -rf ../overlay_ubuntu22_04_LITE/* $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME/
...
cp ../../board/m5stack/module_kit/overlay/usr/* $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME/usr/ -a
cp --preserve=mode,timestamps -rf ../overlay_ubuntu22_04/* $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME/
cp --preserve=mode,timestamps -rf ../overlay_ubuntu22_04_LITE/* $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME/
