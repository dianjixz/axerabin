...
project_name=AX8850_ubuntu22_04_rootfs
work_dir="build_${project_name}"
BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS="https://github.com/m5stack/LLM_buildroot-external-m5stack/releases/download/v0.0.0/ax8850_ubuntu_rootfs_desktop.tar.gz"
BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_SAH256="2917b4bc146137815ea703c1413faa99bd4e43e99c4db3bc0de0c6053b04ef93"
...
ln -s ${BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_SAH256}-ubuntu-base-22.04.5-base-arm64.tar.gz $project_name.tar.gz
# # 解压
